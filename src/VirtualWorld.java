...
public final class VirtualWorld extends PApplet {
	...
	public void mousePressed() {
		...
		Optional<Entity> entityOptional = Entity.getOccupant(world, pressed);
	...
	private Point mouseToPoint(int x, int y) {
		return Point.viewportToWorld(view.viewport, mouseX / TILE_WIDTH, mouseY / TILE_HEIGHT);
	}
	...
	static void loadImages(String filename, ImageStore imageStore, PApplet screen) {
		try {
			Scanner in = new Scanner(new File(filename));
			ImageStore img = new ImageStore();
			img.loadImages(in, imageStore, screen);
